...
// import FunctionsForProteinsComparisonPlot from "./FunctionsForProteinsComparisonPlot";

export default function StatisticsAdFirstPlot({data}){

   // const path = "http://localhost:8000/requestAdChart";
   // {FunctionsForProteinsComparisonPlot(data, path)}
   ...
   const handleSubmit = (event) => {
      ...
      if(validate()){
         axios
             .post(JSON.stringify("http://localhost:8000/requestAdChart"), JSON.stringify(selectedOptions), {
